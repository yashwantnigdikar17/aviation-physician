...
exports.setConnectorOptOut = exports.setConnectorDeviceId = exports.setConnectorUserId = exports.getAnalyticsConnector = void 0;
...
var setConnectorOptOut = function (optOut, instanceName) {
    (0, exports.getAnalyticsConnector)(instanceName).identityStore.editIdentity().setOptOut(optOut).commit();
};
exports.setConnectorOptOut = setConnectorOptOut;
