...
import { Animated, Easing, Modal as ReactNativeModal, Platform, StyleSheet, TouchableWithoutFeedback, View, } from "react-native";
...
export class Modal extends Component {
    ...
    render() {
        const _a = this.props, { children, onBackdropPress, contentStyle, coverScreen } = _a, otherProps = __rest(_a, ["children", "onBackdropPress", "contentStyle", "coverScreen"]);
        ...
        if (!coverScreen && visible) {
            return (React.createElement(View, { pointerEvents: "box-none", style: StyleSheet.absoluteFill }, content));
        }
        return (React.createElement(ReactNativeModal, Object.assign({ transparent: true, animationType: "none" }, otherProps, { visible: visible }), content));
    }
}
Modal.defaultProps = {
...
const styles = StyleSheet.create({
    backdrop: Object.assign(Object.assign({}, StyleSheet.absoluteFillObject), { backgroundColor: "black", opacity: 0 }),
    content: {
        flex: 1,
        alignItems: "center",
