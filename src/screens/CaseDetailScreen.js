...
export default function CaseDetailScreen({ navigation, route }) {
  ...
  const medicinePanelWidth = isSmallTablet ? 285 : 309;
  const vitalsPanelWidth = isSmallTablet ? 205 : 218;
  const headerHorizontalPadding = isSmallTablet ? 12 : 14;
  ...
  const formatMedicineLine = useCallback((medicine) => {
    ...
    const cleanModuleTitle = moduleTitle ? moduleTitle.replace(/:\s*$/, "") : "";
      ...
      <View style={[styles.root, { backgroundColor: t.cdRootBg }]}>
        ...
        <View style={[styles.mainContent, { backgroundColor: t.cdRootBg }]}>
          ...
          <View
            style={[
              styles.patientHeader,
              isSmallTablet && styles.patientHeaderCompact,
              {
                paddingTop: insets.top,
          ...
          >
            <View style={styles.patientTitleWrap}>
              <Text
                style={[
                  styles.patientName,
                  isSmallTablet && styles.patientNameCompact,
                  { color: t.cdPatientName },
                ]}
                numberOfLines={1}
              >
                John Smith, 58 M
            ...
            <View
              style={[
                ...
                isSmallTablet && styles.headerActionsCompact,
              ]}
            >
              {/* ── CHAT BUTTON — toggles inline ChatPanel ── */}
              <TouchableOpacity
          ...
          {/* BODY */}
          <View style={[styles.body, isSmallTablet && styles.bodyCompact]}>
            {/*
             * ── LEFT PANEL ──────────────────────────────────────────────────
             * position: "relative" so that ChatPanel's absoluteFillObject
             * stays within this panel and does NOT bleed into the medicine
    ...
    >
      Event Summary
                  ...
                  >
                    ...
                    >
                      A 62-year-old male passenger on flight AA1234 developed
                      sudden dizziness, slurred speech, facial asymmetry, and
                      right-sided weakness. The case was escalated to the
                      telecare physician team and managed as a suspected
                      stroke/TIA with associated hypoglycemia.
                    </Text>
                  </View>
                  ...
                  >
                    ...
                    >
                      FAST assessment was positive for neurological deficit.
                      Presentation was concerning for stroke/TIA with concurrent
                      low blood glucose.
                    </Text>
                  ...
                  >
                    ...
                    >
                      Crew reported acute neurological symptoms with low blood
                      glucose. Physician advised oxygen, glucose correction,
                      close monitoring, and EMS handoff after landing.
                    </Text>
                  </View>
        ...
        <View
          style={[
            styles.tiaPanel(insets, medicinePanelWidth),
            {
              backgroundColor: t.cdTiaPanelBg,
              borderColor: t.cdTiaPanelBorder,
            },
...
const styles = StyleSheet.create({
  ...
  // ── Medicine Modules panel (same geometry as the old tiaPanel) ──
  tiaPanel: (insets, panelWidth = 309) => ({
    width: panelWidth,
    flexShrink: 0,
    borderLeftWidth: 1,
    borderRightWidth: 1,
