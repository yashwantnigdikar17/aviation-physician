...
{
  return @{
		@"RTNGiphyGridView": NSClassFromString(@"RTNGiphyGridView"), // @giphy/react-native-sdk
		@"RTNGiphyMediaView": NSClassFromString(@"RTNGiphyMediaView"), // @giphy/react-native-sdk
		@"RTNGiphyVideoView": NSClassFromString(@"RTNGiphyVideoView"), // @giphy/react-native-sdk
